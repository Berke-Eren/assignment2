...
/**
 * A type of NewsArticle that is misleading because the expert cited in the article is not credible.
 * 
 * @author Zi Cheng Qiu
 * @version 1.0
 * @since 2025-05-21
...
public class FakeExpertArticle extends NewsArticle {
    ...
    private final String explanation = "This article is based solely on the words of an \"expert\" who is not credible.";
