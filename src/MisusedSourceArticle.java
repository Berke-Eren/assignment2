...
/**
 * A type of NewsArticle that is misleading because a source was misused.
 * 
 * @author Zi Cheng Qiu
 * @version 1.0
 * @since 2025-05-21
...
public class MisusedSourceArticle extends NewsArticle {
    ...
    private final String explanation =  "This article is misleading because the source used does not support the conclusion being made.";
